	...
	public class BaseBuilder
	{
		...
		protected virtual void WriteCS(string className, BaseBind baseBind)
		{
			...
			if (!File.Exists(classPath))
			{
				...
				BuilderManager.Instance.Write(classPath, classStr);
			}
		}
		...
		protected virtual void WriteDesigner(string className, BaseBind baseBind)
		{
			...
			{
				string fieldLine = $"\t[HideInInspector] public {otherBind.Object.GetType().FullName} {otherBind.MemberName} = null;\r\n\t";
			...
			BuilderManager.Instance.Write(designerPath, designerStr);
		}
		...
		public virtual void SaveAsPreab(BaseBind baseBind)
		{
			...
			BuilderManager.Instance.Write(CodeGenGlobalSetting.PrefabJsonPath, json);
			BuilderManager.Instance.WriteDataMgrDesigner(prefabDic.Keys.ToList());
